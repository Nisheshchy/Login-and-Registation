      ...
      <AnimatePresence mode="wait">
        {!isSuccess ? (
          ...
          >
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                <label className="text-[11px] font-bold text-slate-400 uppercase tracking-[0.1em] ml-1" htmlFor="name">
                  Full Name
                </label>
              ...
              {/* Password */}
              <div className="space-y-2">
                <label className="text-[11px] font-bold text-slate-400 uppercase tracking-[0.1em] ml-1" htmlFor="password">
                  Password
                </label>
                <motion.div whileFocus={{ scale: 1.01 }} className="relative group">
                ...
                <div className="px-1 pt-1">
                  <div className="flex justify-between items-center mb-1">
                    <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Strength</span>
                    <span className="text-[10px] text-slate-400 font-bold">{strength === 100 ? "Strong" : strength === 0 ? "" : "Weak"}</span>
                  </div>
          ...
          >
            ...
            >
              Welcome to the family. You can now use your credentials to sign in.
            </motion.p>
            <Link to="/login">
              <motion.button
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 1 }}
                className="mt-8 bg-white/5 border border-white/10 hover:bg-white/10 text-white font-bold py-3 px-10 rounded-xl transition-all"
              >
                Go to Login
              </motion.button>
            </Link>
